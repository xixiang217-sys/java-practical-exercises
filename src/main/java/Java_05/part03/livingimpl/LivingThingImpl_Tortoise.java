package Java_05.part03.livingimpl;

import Java_05.part03.LivingThing;

public class LivingThingImpl_Tortoise implements LivingThing {
    private String shellColor;    // 乌龟外壳颜色

    public LivingThingImpl_Tortoise() {
    }

    public LivingThingImpl_Tortoise(String shellColor) {
    ...
    public void eat(String food) {
        System.out.println("乌龟吃" + food);
    }

    @Override
    public void makeVoice() {
        System.out.println("乌龟很少发声");
    }

    public void crawl(int speed) {
        System.out.println("乌龟每小时爬" + speed + "公里");
    }
}
//3、
//创建接口LivingThing：
