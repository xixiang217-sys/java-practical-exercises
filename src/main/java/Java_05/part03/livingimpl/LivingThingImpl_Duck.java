...
public class LivingThingImpl_Duck implements LivingThing {
    private String color;   // 鸭子颜色
    private int age;        // 鸭子年龄

    public LivingThingImpl_Duck() {
    }

    public LivingThingImpl_Duck(String color, int age) {
        this.color = color;
        this.age = age;
    }
    ...
    public void swim(int km) {
        System.out.println("鸭子每小时游" + km + "公里");
    }
}
//3、
//创建接口LivingThing：
