package Java_05.part02.animalimpl;

import Java_05.part02.Animal;

import java.util.Scanner;

public class AnimalImpl_Cat implements Animal {
    private String name;
    ...
    public AnimalImpl_Cat(String name, String color) {
        this.name = name;
        this.color = color;
    }

    public AnimalImpl_Cat() {
    }
